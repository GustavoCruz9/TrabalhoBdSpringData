...
begin
		...
		set @i = (select count(codDisciplina) from Disciplina where semestre = 1 and codCurso = @codCurso and turno = 'T')
		...
		insert into #disciplinas (cod) 
			   select codDisciplina from Disciplina where semestre = 1 and codCurso = @codCurso and turno = 'T'
...
begin
	...
	set @dataPrimeiraMatricula = (select top 1 CONVERT(VARCHAR, m.dataMatricula, 103) AS dataMatricula from aluno a, Matricula m where a.cpf = m.cpf and a.cpf = @cpf order by m.dataMatricula desc)
...
(1, 'Arquitetura e Organização de Computadores', '03:30', '13:00', '16:30', 'Segunda-feira', 1, 1, 'T'),
(1, 'Arquitetura e Organização de Computadores', '03:30', '19:20', '22:50', 'Segunda-feira', 1, 1, 'N'),
(1, 'Laboratório de Hardware', '03:30', '14:50', '18:20', 'Quarta-feira', 1, 2, 'T'),
(1, 'Banco de Dados', '03:30', '13:00', '16:30', 'Quinta-feira', 1, 2, 'T'),
(1, 'Sistemas Operacionais I', '03:30', '13:00', '16:30', 'Sexta-feira', 1, 3, 'T'),
(1, 'Sistemas Operacionais I', '03:30', '19:20', '22:50', 'Segunda-feira', 1, 1, 'N'),
(1, 'Estruturas de Dados', '1:40', '19:00', '20:40', 'Terça-feira', 2, 2, 'N'),
(1, 'Laboratório de Banco de Dados', '01:40', '14:50', '16:30', 'Quinta-feira', 2, 3, 'T'),
(1, 'Metodologia de Pesquisa Científico Tecnológica', '01:40', '14:50', '16:30', 'Quarta-feira', 1, 1, 'T');

go

-- Inserindo os dados na tabela PesoAvaliacao
